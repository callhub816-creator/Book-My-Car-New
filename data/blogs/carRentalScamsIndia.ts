...
const carRentalScamsIndia: BlogPost = {
  ...
  title: 'Car Rental Scams in India 2026: 5 Common Frauds & Prevention Guide',
  slug: 'car-rental-scams-india',
  excerpt:
    'Refund refused? Fake damages? Learn how to spot and avoid car rental scams in India. 2026 guide for Zoomcar, Revv, and local operator frauds.',
  category: 'Consumer Awareness',
  author: 'Rajesh Navsagar',
  date: '2026-02-13',
  imageUrl: '/images/blogs/car-rental-scams.png',
  keywords: [
    'Car Rental Scams India 2026',
    'Self Drive Car Fraud Prevention',
    'Rental Security Deposit Refund',
    'Fake Damage Charges Rental Car',
    'Illegal White Plate Rental India'
  ],
...
export default carRentalScamsIndia;
