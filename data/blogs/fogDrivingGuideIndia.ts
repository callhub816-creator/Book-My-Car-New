...
const fogDrivingGuideIndia: BlogPost = {
  id: 'fog-driving-survival-guide-north-india',
  title: 'Fog Driving Survival Guide 2026: North India Highway Safety Tips',
  slug: 'fog-driving-survival-guide-north-india',
  excerpt:
    "Zero visibility on Yamuna Expressway? Expert tips for driving in dense fog. Low beam rules, defogging hacks & emergency stops for 2026 winters.",
  category: 'Safety',
  author: 'Rajesh Navsagar',
  date: '2026-02-13',
  imageUrl: '/images/blogs/fog-driving-guide-india.png',
  keywords: [
    'Fog Driving Safety India 2026',
    'Driving in Dense Fog Tips',
    'Yamuna Expressway Fog Rules',
    'High Beam vs Low Beam in Fog',
    'Rear Fog Lamp Use',
    'North India Winter Driving'
  ],
  expertTip: "Sabse badi galti: Hazard lights (double indicators) on karke chalna. Highway par hazard lights ka matlab hota hai 'I am stationary/stopped'. Agar aap chalti gaadi mein use karenge, toh peeche waala confuse ho jayega ki aap rukey ho ya chal rahe ho, aur ramming accident ho sakta hai.",
  content: `
