...
const bestTimeRoadTripIndia2026: BlogPost = {
  ...
  date: '2025-12-28',
  imageUrl: '/images/blogs/day-vs-night.png',
  keywords: [
    'Best time to start road trip India',
    'Day vs Night driving India',
    'Highway safety tips 2026',
    'Early morning driving benefits',
    'India highway driving rules',
    'Night driving risks India expressway'
  ],
...
export default bestTimeRoadTripIndia2026;
