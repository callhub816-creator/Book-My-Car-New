...
const selfDrivePermitExplained: BlogPost = {
  ...
  date: '2026-01-09',
  imageUrl: '/images/blogs/self-drive-permit-guide-2026.png',
  keywords: [
  ...
  expertTip: "Hamesha 'Form 48' (National Permit) ki physical copy mangiye. Bhale hi aaj kal digital documents valid hain, lekin remote border check-posts par physical paper dekhne ke baad hi entry tax process kiya jata hai. No paper = No entry.",
  content: `
